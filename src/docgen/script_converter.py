...
_ROMAN_TO_DEVA: Dict[str, str] = {
    ...
    # Action verbs — multi-word (sorted longest first within this block)
    "kiye ja sakte hain": "किए जा सकते हैं",
    "kiya ja sakta hai":  "किया जा सकता है",
    "banate hain":        "बनाते हैं",
    "banata hai":         "बनाता है",
    "banati hai":         "बनाती है",
    "upyog karte hain":   "उपयोग करते हैं",
    "upyog karta hai":    "उपयोग करता है",
    "upyog karo":         "उपयोग करो",
    "upyog kiya":         "उपयोग किया",
    "store karte hain":   "स्टोर करते हैं",
    "store karta hai":    "स्टोर करता है",
    "store nahi karte":   "स्टोर नहीं करते",
    "iterate karte hain": "इटरेट करते हैं",
    "iterate karta hai":  "इटरेट करता है",
    "iterate karo":       "इटरेट करो",
    "iterate kiya":       "इटरेट किया",
    ...
    "hoti hai":           "होती है",
    "hote hain":          "होते हैं",
    "preserve hota hai":  "प्रिज़र्व होता है",
    "preserve hoti hai":  "प्रिज़र्व होती है",
    ...
    # Tech verb roots (loanwords, phonetic Devanagari)
    "return":    "रिटर्न",
    "store":     "स्टोर",
    "call":      "कॉल",
    "define":    "डिफाइन",
